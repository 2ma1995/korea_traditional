...
/* 새로고침할 때마다 처음부터 재생한다. 건너뛰는 경우는 #앵커로 들어온 딥링크 하나뿐이다.
   동작 줄이기 설정은 보지 않는다 — 저전력 모드에서도 첫 화면은 그대로 보여준다.
...
export default function Intro() {
  const skipPreference = useSyncExternalStore(subscribeToHash, getSkipPreference, () => true);
